...
Page({
  ...
  quickcreateorder: function (data) {
    let that = this
    app.wxrequest({
      url: 'order/quickCreateIntegralOrder',
      data: {
  ...
  gopaystatus: function (data) {
    let that = this
    wx.redirectTo({
      url: '/pages/integShop/paystatus/paystatus?status=' + data.status + '&orderno=' + data.order_no + '&siteid=' + that.data.siteid + '&price=' + that.data.stat.total_price
    })
  },
  /**
   * 支付
  ...
  createsettlement: function (data) {
    let that = this
    app.wxrequest({
      url: "order/createIntegralSettlement",
      data: {
        sku_id_list: that.data.skus,
        user_address_id: that.data.siteid,
        user_coupon_id: that.data.coupon
      ...
      success(res) {
        let stat = {
          ...
          total_goods_price: res.total_goods_integral_price,
          total_price: res.total_goods_integral_price,
          balance: res.balance,
  ...
  quickSettlement: function (data) {
    let that = this
    app.wxrequest({
      url: "order/quickIntegralSettlement",
      data: {
        buid: app.globalData.pid,
        sku_id: that.data.skus,
        num: that.data.num,
      ...
      success(res) {
        let stat = {
          goods_count: res.goods_count,
          rebate_all: res.rebate_all,
          total_goods_price: res.total_integral_price,
          total_price: res.total_integral_price,
        }
        that.setData({
          datalist: res.supplier_list,
          stat: stat,
